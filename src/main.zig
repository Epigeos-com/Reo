...
//     // var shortest_year_length: f64 = 1000;
//     // var shortest_year: i32 = 0;
...
//     //     const first_of_the_next_year = first_of_last_month + @as(f64, @floatFromInt(first_of_last_month_data.days_in_month)) - 1; ///////// days_in_month

//     //     const year_length = first_of_the_next_year - first_of_the_year;
//     //     if (year_length < shortest_year_length) {
//     //         shortest_year_length = year_length;
//     //         shortest_year = year;
//     //     }
//     //     year += 1;
//     // }
//     // std.debug.print("\n\nShortest year length: {d}\n", .{shortest_year_length});
//     // std.debug.print("\n\nShortest year: {d}\n", .{shortest_year - 779});
// }
