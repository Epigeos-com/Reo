...
pub fn getClosestSunPhase(JD: f64, isForward: bool, phase: u8) !(struct {
    ...
    const finalYear = switch (finalI) {
        0 => date.year,
        1 => date.year - 1,
        else => date.year + 1,
    };
    return .{ .JD = sun, .year = finalYear };
}
...
pub fn getNutationValues(JD: f64) [2]f64 {
    ...
    const U = T / 100;
    const epsilon0 = if (settings.useLowPrecisionForNutationEpsilon0) 84381.448 - 46.8150 * T - 0.00059 * T * T + 0.001813 * T * T * T else 84381.448 - 4680.93 * U - 1.55 * U * U + 1999.25 * U * U * U - 51.38 * U * U * U * U - 249.67 * U * U * U * U * U - 39.05 * U * U * U * U * U * U + 7.12 * U * U * U * U * U * U * U + 27.87 * U * U * U * U * U * U * U * U + 5.79 * U * U * U * U * U * U * U * U * U + 2.45 * U * U * U * U * U * U * U * U * U * U;
...
pub fn getTimeOfSunTransitRiseSet(JD: f64, utcOffset: f64, getTransit: bool, getRise: bool, getSet: bool) [3]f64 { // TODO: Make this work
    ...
    const fractionalUtcOffset = utcOffset / 24;
